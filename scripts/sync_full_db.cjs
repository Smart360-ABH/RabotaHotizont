...
const { MOCK_VENDORS, MOCK_PRODUCTS } = require('../constants_js.cjs');
...
async function syncData() {
    console.log('🚀 Starting Data Synchronization to Back4App (CJS)...');
    ...
    try {
        ...
        for (const mp of MOCK_PRODUCTS) {
            ...
            // Fix: use a plain object instead of a File type if schema expects Object
            productObj.set('image', { url: mp.image });
